              ...
              <div class=" modal max-w-full rounded-none p-0">
                ...
                >
                  <div class=" modal-action max-w-[90%] max-h-[90%]">
                    ...
                    <span class="absolute bottom-10 right-20 text-h3">
                      <ul></ul>
                      {imagesList.slice(0, 4).map((img, index) => (
                        <Slider.Dot index={index}>
                          <p class=" hidden group-disabled:flex">{index + 1}</p>
                        </Slider.Dot>
                      ))}
                      /{imagesList.slice(0, 4).length}
                    </span>
                    ...
                    <ul class="flex-1 rounded-none flex-col absolute left-0 top-10 flex gap-2 overflow-auto px-4">
                      {imagesList.slice(0, 4).map((img, index) => (
