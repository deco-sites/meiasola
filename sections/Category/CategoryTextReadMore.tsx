...
function CategoryTextReadMore({
  ...
  return (
    <div class="container flex flex-col laptop:flex-row justify-between w-full gap-4 laptop:gap-[130px] text-black laptop:mt-[58px] mb-10 laptop:mb-[100px]">
